    ...
    public sealed partial class ScrollerDynamicPage : TestPage
    {
        ...
        private void BtnAddSnapPoint_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    ScrollSnapPoint snapPoint = new ScrollSnapPoint(Convert.ToSingle(txtSnapPointValue.Text), Convert.ToSingle(txtSnapPointValueRange.Text), SnapPointsAlignment.Near);

...
ScrollerSnapPointApplicableRangeType SnapPointBase::ApplicableRangeType()
{
...
winrt::SnapPointsAlignment ScrollSnapPointBase::Alignment()
{
    return m_alignment;
}

void ScrollSnapPointBase::Alignment(winrt::SnapPointsAlignment alignment)
{
...
double ScrollSnapPoint::DetermineMinActualApplicableZone(SnapPointBase* previousSnapPoint)
{
    ...
    {
        if (m_applicableRangeType != ScrollerSnapPointApplicableRangeType::Optional)
        {
            return -INFINITY;
        }
        else
    ...
    else
    {
        ...
        {
        case ScrollerSnapPointApplicableRangeType::Optional:
            return std::max(previousMaxInfluence, m_actualValue - m_specifiedApplicableRange);
        case ScrollerSnapPointApplicableRangeType::Mandatory:
